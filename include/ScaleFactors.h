...
public:
  ...
  ScaleFactors(Variables& var) :
    ...
    scale_factors[Region::Pre_Lep_2tau].push_back(&sf_ele_medium);
    scale_factors[Region::Pre_Lep_2tau].push_back(&sf_muon_medium);
    scale_factors[Region::Pre_Lep_2tau].push_back(&sf_btag_medium);

    scale_factors[Region::Pre_Lep_2tau_MET].push_back(&sf_ele_medium);
    scale_factors[Region::Pre_Lep_2tau_MET].push_back(&sf_muon_medium);
    scale_factors[Region::Pre_Lep_2tau_MET].push_back(&sf_btag_medium);

    scale_factors[Region::Pre_Had_2tau].push_back(&sf_ele_veto);
    scale_factors[Region::Pre_Had_2tau].push_back(&sf_muon_veto);
    scale_factors[Region::Pre_Had_2tau].push_back(&sf_btag_medium);
